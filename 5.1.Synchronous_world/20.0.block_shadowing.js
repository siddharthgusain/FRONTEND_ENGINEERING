...
// block
{
    ...
    let b = 200; // not shadows as both "b" variable are different in memory because "let" works this way
    const c = 211; // not shadows as both "c" variable are different in memory because "const" works this way
    console.log(a);
    console.log(b);
    console.log(c);
...
console.log(c); // not shadowed because const declaration
